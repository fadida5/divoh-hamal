...
const loadGdods = async (hativaids) => {
  ...
  const UpdateReport = () => {
    ...
    axios.put(`http://localhost:8000/report/update/${reportid}`, report)
      .then(response => {
  ...
  const init = () => {
    var reportid = match.params.formId;
    axios.get(`http://localhost:8000/report/${reportid}`)
      .then(response => {
...
<Card className="shadow border-0">
  <CardBody className="px-lg-5 py-lg-5">
    ...
    <Form role="form">
      ...
      {(data.typevent === "1" || data.typevent === "2" || data.typevent === "3" || data.typevent === "4") && (
        <>
      <div style={{ textAlign: "right", paddingTop: "10px" }}>
        סיבת האירוע
      </div>
    ...
    {(!(data.magad)) ?
      <Col style={{ justifyContent: 'right', alignContent: 'right', textAlign: 'right' }}>
        <h6>מאגד על</h6>
        <Select data={magadals} handleChange2={handleChange2} name={'magadal'} val={data.magadal ? data.magadal : undefined} />
      </Col> :
      <Col style={{ justifyContent: 'right', alignContent: 'right', textAlign: 'right' }}>
        <h6>מאגד על</h6>
        <Select data={magadals} handleChange2={handleChange2} name={'magadal'} val={data.magadal ? data.magadal : undefined} isDisabled={true} />
      </Col>}

    {((data.magadal) && !(data.mkabaz)) ?
      <Col style={{ justifyContent: 'right', alignContent: 'right', textAlign: 'right' }}>
        <h6>מאגד</h6>
        <Select data={magads} handleChange2={handleChange2} name={'magad'} val={data.magad ? data.magad : undefined} />
      </Col> :
      <Col style={{ justifyContent: 'right', alignContent: 'right', textAlign: 'right' }}>
        <h6>מאגד</h6>
        <Select data={magads} handleChange2={handleChange2} name={'magad'} val={data.magad ? data.magad : undefined} isDisabled={true} />
      </Col>}

    {((data.magad) && !(data.makat)) ?
      <Col style={{ justifyContent: 'right', alignContent: 'right', textAlign: 'right' }}>
        <h6>מקבץ</h6>
        <Select data={mkabazs} handleChange2={handleChange2} name={'mkabaz'} val={data.mkabaz ? data.mkabaz : undefined} />
      </Col> :
      <Col style={{ justifyContent: 'right', alignContent: 'right', textAlign: 'right' }}>
        <h6>מקבץ</h6>
        <Select data={mkabazs} handleChange2={handleChange2} name={'mkabaz'} val={data.mkabaz ? data.mkabaz : undefined} isDisabled={true} />
      </Col>}
      </Row>
